...
class _NoteListItemState extends State<NoteListItem> {
  ...
  Future<void> _loadImage() async {
    ...
    try {
      ...
      bool isFirebaseUrl = widget.note.imageUrl!.startsWith('http') && 
          (widget.note.imageUrl!.contains('firebasestorage.googleapis.com') || 
           widget.note.imageUrl!.contains('firebase') || 
           widget.note.imageUrl!.contains('storage'));
      ...
      if (isFirebaseUrl) {
        ...
        if (downloadedImage == null) {
          try {
            ...
            try {
              final fallbackUrl = 'images/${widget.note.imageUrl!}';
